...
Note, however, that within the encompassing scientific enterprise $\mathcal{E}$, a creative idea may cease to be surprising because $E_\mathcal{E}(z, d)$ may be large, in the case of a singluar idea solution, or $E_\mathcal{E}(z, d_j)$ may not be small for all $j \in [k]$ in the latter case.
