...
const BONUS_BANNER = `<p style="margin: 0 0 24px; padding: 16px 20px; background: #fff6e0; border: 1px solid #e8c85a; border-left: 5px solid #e0a800; border-radius: 6px; font-size: 16px;">
                    <strong>🏆 Bonus:</strong> Your bonus depends on how <strong>original and unusual</strong> your responses are compared with
                    other participants&rsquo;. So take your time and be as original as you can.</p>`;
